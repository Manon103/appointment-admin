<template>
    <div class="background">
        ...
        >
            <h3 class="title" style="margin-bottom: 20px">挂号系统后台管理中心</h3>
...
export default {
                    ...
                    this.$store
                        ...
                        .then(() => {
                            ...
                            if(this.ruleForm2.username === 'admin'){
                              ...
                              getDoctorInfo(this.ruleForm2.username).then(res => {
                                if (res.code === 200) {
                                  sessionStorage.setItem('doctorInfo', JSON.stringify(res.data));
    ...
    created() {
        ...
        if (
            this.ruleForm2.username === undefined ||
